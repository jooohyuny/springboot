...
public class SellController {
	...
	public String dateUpdate(Sell s, HttpServletRequest req, HttpSession session,@RequestParam("id") String itemId,String search) {
		if (mDAO.isLogined(req, session)) {
	...
	public String doUpdate(@RequestParam("photoo") MultipartFile mf, Sell s, HttpServletRequest req,@RequestParam("id") String itemId, @RequestParam("category") String category,HttpSession session,String search) {
		if (mDAO.isLogined(req, session)) {
